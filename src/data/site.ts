export const projects = [
  ...
  },
  {
    ...
    features:
      "Full implementation of the Schnorr digital signature algorithm, including key generation, signing, and verification. Uses multiple cryptographic utility libraries (schnorr_lib, schnorr_lib1, schnorr_lib2) and supports secure message signing & authentication.",
    live: "",
    github: "https://github.com/An1ketGupta/Schnorr-Signature-Implementation",
  },
];
